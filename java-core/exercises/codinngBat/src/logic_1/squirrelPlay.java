...
public class squirrelPlay {
    public static void main(String[] args) {
        System.out.println(squirellPlay(70, false));
        System.out.println(squirellPlay(95, false));
        System.out.println(squirellPlay(95, true));
    }

    public static boolean squirellPlay(int temp, boolean isSummer) {
