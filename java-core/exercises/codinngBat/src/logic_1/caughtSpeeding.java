...
speed is 60 or less, the result is 0. If speed is between 61
and 80 inclusive, the result is 1. If speed is 81 or more,
...
public class caughtSpeeding {
    ...
    public static int caughtSpeeding(int speed, boolean isBirthday) {
        // если др то можно speed на 5 больше
        // используется тернарник
