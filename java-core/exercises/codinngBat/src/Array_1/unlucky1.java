...
public class unlucky1 {
    ...
    public static boolean unlucky1(int[] nums) {
        ...
        boolean firstTwo = (nums[0] == 1 && nums[1] == 3);
        boolean secondTwo = (nums.length > 2) && (nums[1] == 1 && nums[2] == 3);
        boolean lastTwo = (nums[nums.length - 2] == 1 && nums[nums.length - 1] == 3);

        return firstTwo || lastTwo || secondTwo;
    }
}
