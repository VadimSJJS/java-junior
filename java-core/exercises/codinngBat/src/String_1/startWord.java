...
On a match, return the front of the string, or otherwise return
the empty string. So, so with the string "hippo" the word "hi"
returns "hi" and "xip" returns "hip". The word will be at least
length 1.
...
public class startWord {
    ...
    public static String startWord(String str, String word) {
        ...
        if (str.substring(0, wordLength).equals(word)
        || str.substring(1, wordLength).equals(word.substring(1))) {
